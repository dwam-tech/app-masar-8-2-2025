...
//           TextEditingController(text: property.paymentMethod);
//       final areaController = TextEditingController(text: property.area);
//       final submittedByController =
//           TextEditingController(text: property.submittedBy);
//       final submittedPriceController =
//           TextEditingController(text: property.submittedPrice);
...
//                                   property.price = int.tryParse(
//                                           priceController.text.trim()) ??
//                                       property.price;
//                                   property.type = typeController.text.trim();
//                                   property.description =
//                                       descController.text.trim();
//                                   property.bedrooms = int.tryParse(
//                                           bedroomsController.text.trim()) ??
//                                       property.bedrooms;
//                                   property.bathrooms = int.tryParse(
//                                           bathroomsController.text.trim()) ??
//                                       property.bathrooms;
...
//                                   property.submittedBy =
//                                       submittedByController.text.trim();
//                                   property.submittedPrice =
//                                       submittedPriceController.text.trim();
...
//             final isTablet =
//                 constraints.maxWidth >= 768.0; // نفس الـ _tabletBreakpoint
...
//         {
//           "svg": "assets/icons/Nav_Analysis_provider.svg",
//           "label": "الإحصائيات"
//         },
