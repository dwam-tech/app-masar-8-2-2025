...
class RestaurantAnalysisScreen extends StatefulWidget {
  const RestaurantAnalysisScreen({Key? key}) : super(key: key);
...
class _RestaurantAnalysisScreenState extends State<RestaurantAnalysisScreen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: isTablet ? 24 : 16),
                    _buildOrderStatsCard(isTablet),
                    SizedBox(height: isTablet ? 24 : 16),
                    _buildTopDishesCard(isTablet),
                  ],
                ),
              ),
            ),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _buildLegendItem('عدد الطلبات', Colors.orange, isTablet),
            ],
          ),
        ],
      ),
  ...
  Widget _buildOrderStatsCard(bool isTablet) {
    return Container(
      padding: EdgeInsets.all(isTablet ? 24 : 16),
      decoration: BoxDecoration(
        color: Colors.white,
            ...
            children: [
              ...
              Expanded(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildPieChartLegend('مسلم', '615', Colors.blue, isTablet),
                    SizedBox(height: isTablet ? 12 : 8),
                    _buildPieChartLegend('قيد التنفيذ', '539', Colors.red, isTablet),
                    SizedBox(height: isTablet ? 12 : 8),
                    _buildPieChartLegend('ملغي', '815', Colors.grey, isTablet),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildTopDishesCard(bool isTablet) {
    return Container(
      padding: EdgeInsets.all(isTablet ? 24 : 16),
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          GridView.count(
            ...
            childAspectRatio: 1,
            children: [
              _buildDishCard('بيتزا مارجريتا', '(199)', isTablet),
              _buildDishCard('بيتزا مارجريتا', '(199)', isTablet),
              _buildDishCard('بيتزا مارجريتا', '(199)', isTablet),
              _buildDishCard('بيتزا مارجريتا', '(199)', isTablet),
              _buildDishCard('بيتزا مارجريتا', '(199)', isTablet),
  ...
  Widget _buildDishCard(String name, String count, bool isTablet) {
    return Container(
